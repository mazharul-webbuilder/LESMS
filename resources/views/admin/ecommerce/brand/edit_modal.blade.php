<div class="modal fade brand_edit_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                    ...
                    <div class="card-body">
                        ...
                        <form id="brandAddForm" action="" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group row mb-4">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="name" placeholder="Ex: Walton" name="name">
                            ...
                            <div class="form-group row mb-4">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <span class="error-message" id="email-error"></span>
                                    <br>
                                    <img src="" id="logo" class="img-thumbnail" alt="" height="100px" width="100px">
                                </div>
                            </div>
                            <div class="form-group row mb-4">

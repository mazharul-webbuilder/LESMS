...
<main class="main_wrapper">
            ...
            <div class="row">
                ...
                <div class="col-xl-5 col-lg-5 col-md-12 col-sm-12 col-12" data-aos="fade-up">
                    ...
                    <div class="herobanner__video registerarea__video">
                        <img src="{{ asset('asset/img') }}/herobanner/herobanner__video.jpg" alt="Video Banner">

                        <div class="video__pop__btn">
                            <a class="video-btn" href="https://www.youtube.com/watch?v=vHdclsdkp28"> <img src="{{ asset('asset/img') }}/icon/video.png" alt=""></a>
                        </div>
                    </div>
                ...
                <div class="herobannerarea__icon__2">
                    <img class="herobanner__common__img herobanner__img__1" src="{{ asset('asset/img') }}/herobanner/herobanner__1.png" alt="photo">
                    <img class="herobanner__common__img herobanner__img__2" src="{{ asset('asset/img') }}/herobanner/herobanner__2.png" alt="photo">
                    <img class="herobanner__common__img herobanner__img__3" src="{{ asset('asset/img') }}/herobanner/herobanner__3.png" alt="photo">
                    <img class="herobanner__common__img herobanner__img__4" src="{{ asset('asset/img') }}/herobanner/herobanner__4.png" alt="photo">
                    <img class="herobanner__common__img herobanner__img__5" src="{{ asset('asset/img') }}/herobanner/herobanner__5.png" alt="photo">
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12" data-aos="fade-up">
                    <div class="about__right__wraper__2 about__right__wraper__4">
                        <div class="educationarea__img" data-tilt>
                            <img class="aboutimg__4__img__1" src="{{ asset('asset/img') }}/about/about_13.png" alt="about">
                            <img class="aboutimg__4__img__2" src="{{ asset('asset/img') }}/about/about_12.png" alt="about">
                        </div>
        ...
        <div class="container">
            ...
            <div class="row grid" data-aos="fade-up">
                    ...
                    <div class="gridarea__wraper">
                        ...
                        <div class="gridarea__content">
                            ...
                            <div class="gridarea__bottom">
                                ...
                                <a href="instructor-details.html">
                                    <div class="gridarea__small__img">
                                        <img src="{{ asset('asset/img') }}/grid/grid_small_5.jpg" alt="grid">
                                        <div class="gridarea__small__content">
                                            <h6>Micle Robin</h6>
                                        </div>
                                    </div>
                ...
                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12 grid-item filter5 filter2">
                    <div class="gridarea__wraper">
                        <div class="gridarea__img">
                            <a href="course-details.html"><img src="{{ asset('asset/img') }}/grid/grid_6.png" alt="grid"></a>
                            <div class="gridarea__small__button">
    ...
    <div class="registerarea sp_top_90">
        ...
        <div class="registerarea__img">
            <img class="register__1" src="{{ asset('asset/img') }}/register/register__1.png" alt="register">
            <img class="register__2" src="{{ asset('asset/img') }}/register/register__2.png" alt="register">
            <img class="register__3" src="{{ asset('asset/img') }}/register/register__3.png" alt="register">
        </div>
    </div>
    <!-- register__section__start-->
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12" data-aos="fade-up">
                    <div class="single__team">
                        <div class="teamarea__img">
                            <img src="{{ asset('asset/img') }}/team/team__1.png" alt="team">
                ...
                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12" data-aos="fade-up">
                    <div class="single__team">
                        <div class="teamarea__img">
                            <img src="{{ asset('asset/img') }}/team/team__2.png" alt="team">
                            <div class="teamarea__icon">
                                <ul>
                                    <li>
                                        <a href="#"> <i class="icofont-facebook"></i></a>
                ...
                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12" data-aos="fade-up">
                    <div class="single__team">
                        <div class="teamarea__img">
                            <img src="{{ asset('asset/img') }}/team/team__3.png" alt="team">
                            <div class="teamarea__icon">
                                <ul>
                                    <li>
                                        <a href="#"><i class="icofont-facebook"></i></a>
            ...
            <div class="row">
                        ...
                        <div class="testimonialarea__paragraph__3 ">
                            ...
                            <div class="testimonialarea__person__3">
                                <div class="testimonial__img__3">
                                    <img src="{{ asset('asset/img') }}/testimonial/testi_2.png" alt="">
                                </div>
                ...
                <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12" data-aos="fade-up">
                    <div class="testimonial__group__img" data-tilt>
                        <img src="{{ asset('asset/img') }}/testimonial/testi__group__1.png" alt="">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12" data-aos="fade-up">
                    <div class="single__blog__wraper">
                        <div class="single__blog__img">
                            <img src="{{ asset('asset/img') }}/blog/blog_5.png" alt="blog">
                ...
                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12" data-aos="fade-up">
                    <div class="single__blog__wraper">
                        <div class="single__blog__img">
                            <img src="{{ asset('asset/img') }}/blog/blog_24.png" alt="blog">
                            <div class="single__blog__button">
                                <a class="default__button" href="#">Story</a>
                            </div>
                        </div>
                ...
                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12" data-aos="fade-up">
                    <div class="single__blog__wraper">
                        <div class="single__blog__img">
                            <img src="{{ asset('asset/img') }}/blog/blog_25.png" alt="blog">
                            <div class="single__blog__button">
                                <a class="default__button" href="#">Story</a>
                            </div>
                        </div>
